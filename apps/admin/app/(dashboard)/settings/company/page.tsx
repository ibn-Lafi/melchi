...
export default async function CompanySettingsPage() {
  ...
  if (!hasPermission(role, "manage_settings")) redirect("/settings");
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        breadcrumb={<Breadcrumb items={["لوحة التحكم", "الإعدادات", "بيانات الشركة"]} />}
        title="بيانات الشركة والفوترة"
        subtitle="تظهر بترويسة كل فاتورة وتُستخدم بتوليد QR (راجع requirements.md §8.1)"
      />
